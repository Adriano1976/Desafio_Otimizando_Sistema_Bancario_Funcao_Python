...
def criar_usuario(usuarios):
    ...
    endereco = input("Informe o endereço (logradouro, nª - bairro - cidade/sigla estado): ")
...
def main():
    ...
    contas = []
    num_saques_dia = 0
    dia_atual = datetime.datetime.now().date()  # Defina a data atual
